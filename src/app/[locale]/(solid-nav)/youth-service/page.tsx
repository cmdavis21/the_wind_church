...
import YouthRegisterForm from '@/components/forms/youth-register-form/YouthRegisterForm';
...
import { getYouthServicePageDetails } from '@/data/services/sanity/queries/youth-service-page';
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${WEBSITE_BASE_URL}/youth-sunday-service`,
  },
};

const YouthService = async () => {
  const youthServiceInfo = await getYouthServicePageDetails();
  const events = await getAllEvents({ hostName: 'Youth Service' });
  return (
    <div className="px-padding flex flex-col gap-xxl lg:gap-[100px] 2xl:gap-[125px]">
      <PageHeaderWithBackground
        ...
        title="Youth Service"
        subtitle="Sunday Services provided for youth ages 1 to 16"
      />
      ...
      <div className="flex flex-col gap-xl md:gap-xxl">
        ...
        {youthServiceInfo && youthServiceInfo.cirriculum_file && (
          <a
            href={youthServiceInfo.cirriculum_file}
      ...
      {/* Educators */}
      {youthServiceInfo && youthServiceInfo.educators && (
        <div className="flex flex-col gap-xl md:gap-xxl">
          <SectionHeader
            noPadding
          ...
          <div>
            ...
            <div className="hidden md:block">
              <div className="grid grid-cols-3 lg:grid-cols-4 gap-xl mx-auto">
                {youthServiceInfo.educators.map((educator) => (
                  <LeaderCard
            ...
            <SimpleCarousel
              className="md:hidden"
              slides={youthServiceInfo.educators.map((educator) => (
                <LeaderCard
