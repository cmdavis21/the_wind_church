  ...
  <div>
    ...
    <div className="pt-padding flex flex-col gap-xxl lg:gap-[100px] 2xl:gap-[125px]">
      ...
      <div className="px-padding flex flex-col gap-lg">
        ...
        />
        <h4>
          Salvation is God&apos;s plan to provide man an escape from the
          consequences of sin. Being saved or born again is the most important
          experience in your life (John 3:3, 15, 16). When you confess Jesus as
          Lord and Savior, you experience the new birth. Every abundant blessing
          He has for us in freely available in salvation (Romans 10:9-10). The
          word salvation comes from the Greek word soteria, which means saved,
          healed, delivered, pardoned, rescued, protected, preserved, made
          whole, cured, set free, and restored.
        </h4>
      </div>
      ...
      <div className="px-padding flex flex-col gap-lg">
        ...
        <h4>
          If you answered{" "}
          <span
            className={`${permanentMarker.className} text-yellow dark:text-softYellow`}
          >
            Yes
          </span>
        ...
        <h4>
          Remember God loves you. He wants you to be whole and complete or saved
          - spiritually, emotionally, physically, mentally, financially, and
          socially (3 John 2). Pray this prayer, mean it, and you will be saved,
      ...
      <ColorBackgroundAndContent
        ...
        content={
          <div className="flex flex-col gap-lg">
            ...
            />
            <h4>
              Father in heaven, thank you for sending your Son, Jesus, to die on
              the cross for me, and for His blood that was shed to redeem me and
              to cleanse me from my sins.
            </h4>
            <h4>
              Lord, I am sorry and I repent of my sins. Forgive me. I understand
              that I must change the course of my life. I am determined in my
              heart to follow you. I invite you to become the Lord of my life
              from this point forward, forever.
            </h4>
            <h4>
              I openly proclaim and confess that you are the Lord of my life. I
              believe in my heart that You have been raised from the dead.
              Therefore I am saved. I am a new creature. The old things have
              passed. All things have become new.
            </h4>
      ...
      <div className="px-padding flex flex-col gap-lg">
        ...
        <div className="flex flex-col gap-md py-sm">
          ...
          <div className="flex items-center gap-xs">
            <Caret className="fill-yellow rotate-90 min-w-[25px] min-h-[25px] size-[25px]" />
            <h4>
              You have peace with God and access to Him - (Romans 5:1-2,
              Ephesians 2:6-7)
            </h4>
          </div>
          <div className="flex items-center gap-xs">
        ...
        <h4>
          Remember, feelings have nothing to do with salvation. You may feel
          like you are floating on a cloud, or as dull as a doorknob. It makes
          no difference. Trusting God&apos;s Word is what counts.
        </h4>
        <h4 className="pb-xl">
          We would love to pray for you as you embark on your new walk with
          Christ. Feel free to submit a prayer request.
        </h4>
        <PrayerRequestForm />
      </div>
        ...
        content={
          <div className="text-center flex flex-col gap-lg">
            ...
            <h5 className="lg:max-w-[65%] mx-auto">
              Learn more about our deep dive sessions and ministries offered
              here at The Wind.
            </h5>
