...
const otherWaysToGiveArr = [
  <ImageWithTitleAndHiddenTextCard
    ...
    description={
      <>
        The Wind church accepts check and bill pay. Donation boxes are available
        at both exits of the sanctuary.
        <Button
          pill
          size="lg"
          color="yellow"
  ...
  <ImageWithTitleAndHiddenTextCard
    ...
    description={
      <>
        If you have any other assets (vehicles, real estate, etc.) you would
    ...
    <div className="p-padding flex flex-col gap-xxl lg:gap-[100px] 2xl:gap-[125px]">
      ...
      <div className="flex flex-col gap-xl py-[20px] md:py-[50px] 2xl:px-[100px]">
        ...
        <div className="flex flex-col gap-lg">
          ...
          />
          <h4>
            we imitate God&apos;s nature as a giver of eternal and temporal
            blessings.
          </h4>
          <div className="body-large flex flex-wrap gap-sm items-center">
            {[
        ...
        <div className="flex flex-col gap-lg">
          ...
          />
          <h4>
            and relationship with God, communicates our faith to the world, and
            brings personal blessings through wise investments.
          </h4>
          <div className="body-large flex flex-wrap gap-sm items-center">
            {["2 Corinthians 9:12-15", "Acts 20:35", "Luke 12:33"].map(
              (verse, index) => (
                <React.Fragment key={`about-page-vision-verses-${verse}`}>
                  {verse}
                  {index !== 2 && (
      ...
      <div className="flex flex-col gap-xl md:gap-xxl">
        ...
        <div className="hidden md:flex flex-wrap gap-xxl justify-center">
          {otherWaysToGiveArr.map((i) => i)}
        </div>

        <SimpleCarousel
          blueDots
          className="md:hidden h-fit"
          slides={otherWaysToGiveArr}
        />
      </div>
      ...
      <div className="flex flex-col gap-xl md:gap-xxl">
        ...
        <Accordion
          content={[
            ...
            {
              title:
                "Can I allocate my donation to a specific ministry or fund?",
              description:
            ...
            },
            {
              ...
              description: (
                <>
                  You can give during any of our services by placing your
                  donation in the offering basket or drop box.
                  <br />
                  <br />
      ...
      <ColorBackgroundAndContent
        ...
        content={
          <div className="text-white text-center flex flex-col gap-xl">
            <h3>
              We{" "}
              <span className={`${permanentMarker.className} text-yellow`}>
                Thank You for your
              </span>{" "}
              financial{" "}
              <span className={`${permanentMarker.className} text-yellow`}>
            ...
            <h4 className="md:max-w-[80%] mx-auto">
              ...
              <br /> that you have chosen this Ministry as a place to sow your
              seed.
            </h4>
            <h4 className="md:max-w-[80%] mx-auto">
