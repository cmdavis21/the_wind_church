    ...
    <div className="p-padding flex flex-col gap-xxl lg:gap-[100px] 2xl:gap-[125px]">
      ...
      <div className="flex flex-col gap-lg py-[20px] md:py-[50px] 2xl:px-[100px]">
        ...
        <h4>
          ...
          accusantium debitis dolores blanditiis consequatur suscipit adipisci
          ipsum id eligendi accusamus molestiae aspernatur natus ratione
          veritatis. Explicabo, ipsa tempore. Ipsum.
        </h4>
        <div className="flex flex-col gap-md">
          <OpenWindowWithQueryButton
            label={"6476 Streeter Avenue Riverside, CA 92504"}
          />
              ...
              description: (
                <>
                  ...
                  <div className="flex gap-xs py-sm">
                    <Caret fill="#FFD300" className="rotate-90" />
                    <p className="body-large">
                      For service, kids will be lead to our classrooms where
                      they can be taught at a level for them.
                    </p>
                  </div>
