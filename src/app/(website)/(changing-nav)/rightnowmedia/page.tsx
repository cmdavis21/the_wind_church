  ...
  <div className="relative min-h-screen">
    ...
    <div className="relative w-full min-h-screen flex items-center text-white">
      <div className="w-full p-padding nav-padding lg:max-w-[50%] space-y-xl">
        <h1>
          <span className="text-yellow">Maximize your impact</span> and save
          time with the world&apos;s largest video-streaming library of biblical
          resources.
        </h1>

        <h3 className="font-semibold">
          Join now and get access to RightNow Media for{" "}
          <span className="text-yellow">FREE</span> by becoming a wind member.
        </h3>
