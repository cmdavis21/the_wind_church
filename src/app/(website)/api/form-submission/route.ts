import { mailer } from '@/data/server/aws/ses/mailer';
import { baseTemplate, renderTemplate } from '@/data/server/aws/ses/utils';
import { EMAIL_NO_REPLY, EMAIL_OFFICE } from '@/data/server/env.server';
