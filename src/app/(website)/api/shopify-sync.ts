...
//         break;
//       case 'delete':
//         const documentIds = body.productIds.map((id: string) => getDocumentProductId(id));
...
//   const { featuredImage, id, options, productType, priceRange, status, title, variants } = product;
...
//           ? variant.inventoryPolicy === 'continue' || variant.inventoryQuantity > 0
//           : true,
