export const theme = {
  ...
  button: {
    ...
    color: {
      ...
      info: "border border-charcoal bg-transparent text-charcoal hover:bg-yellow hover:text-black hover:border-yellow",
    },
  ...
  modal: {
    ...
    content: {
      ...
      inner:
        "relative flex flex-col max-h-[90dvh] rounded-lg bg-white shadow dark:bg-gray-700",
    },
    body: {
