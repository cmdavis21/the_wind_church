...
// const getPastLiveStreams = async (): Promise<YouTubeSnippet[]> => {
...
//     queryKey: ["YOUTUBE PAST LIVE STREAMS"],
//     queryFn: getPlaylistVideos,
//   });
//   return {
//     playlistVideos: data,
//     playlistVideosLoading: isLoading,
//   };
// };

// export const useGetPastLiveStreams = () => {
//   const { data, isLoading } = useQuery({
//     queryKey: ["YOUTUBE PAST LIVE STREAMS"],
//     queryFn: getPastLiveStreams,
//   });
//   return {
//     pastLiveStreams: data,
//     pastLiveStreamsLoading: isLoading,
//   };
// };
