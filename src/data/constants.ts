...
export const RIGHTNOW_MEDIA_KEY = 'SANITY MUTATION CREATE RIGHTNOW MEDIA SIGNUP';
export const SCHEDULE_VISIT_KEY = 'SANITY MUTATION CREATE SCHEDULE VISIT';
export const VISITOR_FEEDBACK_KEY = 'SANITY MUTATION CREATE CONTACT';
export const NEXT_GEN_ROSTER_KEY = 'SANITY MUTATION CREATE NEXT GEN ROSTER SIGNUP';
export const GET_CART_KEY = 'SHOPIFY QUERY GET CART';
export const GET_ADMIN_CUSTOMER_KEY = 'SHOPIFY QUERY GET ADMIN CUSTOMER';
export const GET_STOREFRONT_COLLECTIONS_KEY = 'SHOPIFY QUERY GET ALL STOREFRONT COLLECTIONS';
export const GET_STOREFRONT_PRODUCTS_KEY = 'SHOPIFY QUERY GET ALL STOREFRONT PRODUCTS';
export const GET_STOREFRONT_PRODUCT_BY_HANDLE_KEY =
  'SHOPIFY QUERY GET STOREFRONT PRODUCT BY HANDLE';
