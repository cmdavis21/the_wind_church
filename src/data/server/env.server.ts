...
// SHOPIFY
export const SHOPIFY_ADMIN_API_ENDPOINT = process.env.SHOPIFY_ADMIN_API_ENDPOINT ?? '';
export const SHOPIFY_ADMIN_ACCESS_TOKEN = process.env.SHOPIFY_ADMIN_ACCESS_TOKEN ?? '';
export const SHOPIFY_STOREFRONT_API_ENDPOINT = process.env.SHOPIFY_STOREFRONT_API_ENDPOINT ?? '';
