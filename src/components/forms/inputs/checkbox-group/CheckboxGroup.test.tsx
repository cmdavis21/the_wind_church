...
describe('CheckboxGroup', () => {
  ...
  it('should render the label and select element', () => {
    render(<CheckboxGroup label={labelText} options={options} name={''} />);
  ...
  it('should render options correctly', () => {
    render(<CheckboxGroup label={labelText} options={options} />);
  ...
  it('should display an error message when provided', () => {
    ...
    render(<CheckboxGroup label={labelText} options={options} error={errorMessage} />);
