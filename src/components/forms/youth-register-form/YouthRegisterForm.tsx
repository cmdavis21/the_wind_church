...
import YouthRegisterGuardiansForm from './youth-register-guardians-form/YouthRegisterGuardiansForm';
...
const YouthRegisterForm = () => {
  ...
  const {
    ...
    control,
    formState: { errors },
  } = useForm<YouthRegistrationInquiry>({
    mode: 'onSubmit',
  ...
  const onSubmit = (values: YouthRegistrationInquiry) => submitInquiry(values);

  return (
    <form
      onSubmit={handleSubmit(onSubmit)}
      className="relative w-full border border-lightGray dark:bg-softGray dark:border-softCharcoal dark:text-softWhite shadow-lg p-md md:p-lg lg:p-xl flex flex-col gap-lg rounded-lg max-w-[1200px] mx-auto"
    >
      <div className="flex items-center gap-sm">
        <PencilPaper className="dark:fill-softWhite" />
        <h4>Youth Service & Nursery Registration Inquiry</h4>
      </div>
...
export default YouthRegisterForm;
