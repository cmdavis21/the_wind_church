...
const FooterContactSignup = () => {
  ...
  return (
    <div
      ...
      className="relative max-lg:min-w-full lg:w-full md:rounded-xl -my-5 -mr-[25px] max-lg:-ml-[25px] 2xl:-mr-[50px] min-[1800px]:-mr-[200px] overflow-hidden"
    >
      <video
        loop
        muted
      ...
      {/* Form */}
      <div className="absolute top-0 left-0 flex flex-col gap-sm max-w-[235px] min-h-[342px] ml-[25px] lg:ml-[50px] my-5 pb-xs">
