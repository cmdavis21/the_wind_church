  ...
  <div className={cn('flex items-center justify-between gap-md', className)}>
    <button
      ...
      className={cn(
        ...
        'flex justify-center items-center size-8 sm:size-10 lg:size-11',
        leftArrowProps.buttonClassName
      )}
    >
      <ChevronLeft className="fill-white size-5 sm:size-6 lg:size-7" />
    </button>
    ...
    >
      <ChevronLeft className="rotate-180 fill-white size-5 sm:size-6 lg:size-7" />
    </button>
  </div>
);
